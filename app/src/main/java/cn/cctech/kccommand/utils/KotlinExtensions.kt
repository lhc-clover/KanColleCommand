package com.gaodesoft.ecoallogistics.assistant
...
inline fun <reified T> BaseFragment.findView(@IdRes res: Int): T {
    @Suppress("UNCHECKED_CAST")
...
inline fun <reified T> BaseFragment.findViewLazy(@IdRes res: Int): Lazy<T> {
    @Suppress("UNCHECKED_CAST")
