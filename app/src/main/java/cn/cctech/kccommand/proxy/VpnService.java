    ...
    */
    private final class CommandHandler extends Handler {
        ...
        private void handleIntent(Intent intent) {
            final SharedPreferences prefs = PreferenceManager.getDefaultSharedPreferences(VpnService.this);
            ...
            if (prefs.getBoolean("screen_on", true)) {
                ...
                if (prefs.getBoolean("screen_on", true)) {
                    last_interactive = Util.isInteractive(VpnService.this);
        ...
        private void reload() {
            SharedPreferences prefs = PreferenceManager.getDefaultSharedPreferences(VpnService.this);
    ...
    private BroadcastReceiver interactiveStateReceiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (interactive || delay == 0) {
                ...
                reload("interactive state changed", VpnService.this);
            } else {
    ...
    private BroadcastReceiver idleStateReceiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (!pm.isDeviceIdleMode())
                reload("idle state changed", VpnService.this);
        }
    };
    ...
    private BroadcastReceiver connectivityChangedReceiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            Log.i(TAG, "Received " + intent);
            Util.logExtras(intent);
            reload("connectivity changed", VpnService.this);
        }
    };
